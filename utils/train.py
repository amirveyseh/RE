...
parser.add_argument('--data_dir', type=str, default='dataset/bc-full')
parser.add_argument('--vocab_dir', type=str, default='dataset/vocab-bc-full')
...
parser.add_argument('--adj_l2', type=float, default=0.01, help='L2-penalty for all adj output.')
